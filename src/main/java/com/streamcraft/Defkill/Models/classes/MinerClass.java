 ...
 * Date: 24.10.13  18:59
 */
public class MinerClass implements DKClass {
    ...
    public MinerClass() {
        ...
        ItemStack tmp = new ItemStack(Material.STONE_PICKAXE, 1);
        tmp.addEnchantment(Enchantment.DURABILITY, 1);
        startKit.add(NBTUtils.setExclusive(tmp));
        startKit.add(new ItemStack(Material.COAL, 4));
        startKit.add(new ItemStack(Material.FURNACE, 1));
    ...
    public MaterialData getIcon() {
        MaterialData tmp = new MaterialData(Material.STONE_PICKAXE);
    ...
    public String getDescription() {
        return "При копинии руды есть шанс что " + ChatColor.AQUA + "выпадет 2 блока из одного.\n" + ChatColor.AQUA + "Также твоя кирка с Эффективностью 1й " + ChatColor.AQUA + "спетени помогает быстро добывать " + ChatColor.AQUA + "ресурсы.";
    }
